...
>Class Question:
Q. Find furity candy with a winpercent above 50%?
...
```
But. . .
I want more custom color scheme where I can see both chocolate and bar and fruity etc. all from the one plot. To do this we can roll our own color vector
